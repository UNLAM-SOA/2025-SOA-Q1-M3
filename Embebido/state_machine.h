...
states state_table_next_state[MAX_STATES][MAX_EVENTS] = {
    ...
    {ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_SCANNING_AT_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS, ST_MOVING_TO_PILL_POS},                                                                                                                                                                                            /*ST_STOP_MOVING*/
